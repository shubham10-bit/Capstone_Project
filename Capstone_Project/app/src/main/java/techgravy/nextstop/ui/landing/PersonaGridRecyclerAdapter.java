...
public class PersonaGridRecyclerAdapter extends RecyclerView.Adapter<PersonaGridRecyclerAdapter.ViewHolder> {
    private Context context;
    private List<PersonaTags> tagList;
    private LayoutInflater layoutInflater;
    private PersonaInterface personaInterface;

    public PersonaGridRecyclerAdapter(Context context, List<PersonaTags> tagList) {
